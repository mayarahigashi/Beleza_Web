						...
						<div class="row">
							<div class="col s12 m12 l12">
								...
								<table id="data-table-simple" class="responsive-table display"
									...
									<tbody>
										<%
											List<ProfissionalDTO> lista = (List<ProfissionalDTO>) request.getAttribute("listaProfissionais");
											DateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
											for (ProfissionalDTO profissionalDTO : lista) {
										%>
											<tr>
												<td><%= profissionalDTO.getNome() %></td>
												<td><%= profissionalDTO.getSexo() %></td>
												<td><%= dateFormat.format(profissionalDTO.getDtNascimento()) %></td>
												<td><%= profissionalDTO.getCelular() %></td>
												<td><%= profissionalDTO.getEmail() %></td>
												<td><a class="btn-floating waves-effect waves-light" href="profissional?acao=editar&id=<%= profissionalDTO.getIdPessoa() %>"><i class="mdi-content-create"></i></a></td>
												<td><a class="btn-floating waves-effect waves-light" href="profissional?acao=remover&idProfissional=<%= profissionalDTO.getIdPessoa() %>&idEndereco=<%= profissionalDTO.getEnderecoDTO().getIdEndereco()%>"><i class="mdi-content-clear"></i></a></td>
											</tr>
										<%
											}
										%>
