	          	...
	          	<div class="container">
	            	<div class="row">
	              		<div class="col s12 m12 l12">
	                		<h5 class="breadcrumbs-title">LISTA DE SERVIÇOS</h5>
	                		<ol class="breadcrumb">
						...
						<div class="row">
							<div class="col s12 m12 l12">
								...
								<table id="data-table-simple" class="responsive-table display"
									...
									<tbody>
										<%
											List<ServicoDTO> lista = (List<ServicoDTO>) request.getAttribute("listaServicos");;
											for (ServicoDTO servicoDTO : lista) {
										%>
											<tr>
												<td><%= servicoDTO.getNomeServico() %></td>
												<td>R$ <%= servicoDTO.getValorServico() %></td>
												<td><%= servicoDTO.getTempoExecucao() %></td>
												<td><a class="btn-floating waves-effect waves-light" href="servico?acao=editar&id=<%= servicoDTO.getIdServico() %>"><i class="mdi-content-create"></i></a></td>
												<td><a class="btn-floating waves-effect waves-light" href="servico?acao=remover&idServico=<%= servicoDTO.getIdServico() %>"><i class="mdi-content-clear"></i></a></td>
											</tr>
										<%
											}
										%>
